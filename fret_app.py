...
# CUSTOM CSS: Forces high-contrast visibility for metrics on white cards
st.markdown("""
    <style>
    .main { background-color: #0e1117; color: white; }
    /* Force dark blue text for metric values */
...
if 'auto_f0' not in st.session_state:
    # Baseline default from your lab notes
    st.session_state.auto_f0 = 3787.66 

# --- SIDEBAR: INPUTS ---
st.sidebar.header("🔬 Physical Constants")
# [cite_start]Constants from the research paper [cite: 702]
...
st.write("Automated analysis of spectral overlap ($J$), Förster distance ($R_0$), and quenching efficiency.")
    ...
    try:
        ...
        if st.button("🚀 Calculate FRET Parameters"):
            try:
                ...
                # 2. Förster Distance (R₀) calculation
                ...
                # Scientific formatting: 3 decimal places + power of 10
